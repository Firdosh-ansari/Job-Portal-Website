  ...
  return (
    <div className='flex flex-wrap gap-4 my-10 justify-center px-10'>
      ...
      >
        ...
        <option value="In-office">In-office</option> {/* fixed value */}
      ...
      <button
        onClick={search}
        className='w-64 bg-blue-500 text-white font-bold py-3 rounded-md hover:bg-blue-600 transition-all'
      >
        Search
      </button>
    </div>
